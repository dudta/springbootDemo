...
public interface DnInfoSapMapper {
    ...
    int updateByExampleSelective(@Param("record") DnInfoSap record, @Param("example") DnInfoSapExample example);

    int updateByExample(@Param("record") DnInfoSap record, @Param("example") DnInfoSapExample example);
	...
	List<DnInfoSap> selectBySoAndSoItem(@Param("so") String so, @Param("soItem") String soItem);
}